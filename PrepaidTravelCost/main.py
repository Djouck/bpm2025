...
df['remaining_time_minutes'] = df['remaining_time_sec']/60
df['remaining_time_hours'] = df['remaining_time_sec']/3600
df['remaining_time_days'] = df['remaining_time_sec']/(3600*24)
...
with open('PrepaidTravelCost.g', 'r') as file:
