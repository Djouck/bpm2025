...
input_file_path = 'BPI2012_SE.xes'
...
with open('BPI2012_SE_instance_graphs.g', 'r') as file:
...
for index, r in df.iterrows():
    if not os.path.exists(f'Sub_Instance_graphs/sub_instance_graph_{index}.g'):
        prova = r['Status_ALL']
        list_to_graph = []
