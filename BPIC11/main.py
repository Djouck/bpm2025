...
input_file_path = 'BPIC11_Final_Data_File_Reg.csv'
...
df.rename(columns={"Case ID": "case:concept:name", 'Activity code': 'concept:name'}, inplace=True)
...
with open('BPIC11rightOrder.g', 'r') as file:
